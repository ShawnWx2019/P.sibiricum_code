...
# Output
my_output <- paste("../03.Progress/02.Pacbio/","busco_figure.pdf",sep="/")
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('HJ', 'HJ', 'HJ', 'HJ', 'HJ_ALL', 'HJ_ALL', 'HJ_ALL', 'HJ_ALL')
...
my_percentage <- c(27.1, 57.8, 4.4, 10.7, 11.0, 74.4, 4.0, 10.6)
my_values <- c(878, 1872, 141, 345, 356, 2409, 129, 342)
