...
# Output
my_output <- paste("summary/","busco_figure.png",sep="/")
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('CD_hit', 'CD_hit', 'CD_hit', 'CD_hit', 'Consensus_isoforms', 'Consensus_isoforms', 'Consensus_isoforms', 'Consensus_isoforms')
...
my_percentage <- c(30.4, 53.2, 5.2, 11.2, 13.9, 69.9, 4.9, 11.3)
my_values <- c(129, 226, 22, 48, 59, 297, 21, 48)
...
ggsave(filename = "../03.Progress/02.Pacbio/QC/BUSCO.pdf",plot = figure, width = 8, height = 5)
print("Done")
